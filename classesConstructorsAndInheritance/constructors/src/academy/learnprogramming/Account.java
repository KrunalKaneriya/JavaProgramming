...
public class Account {
    ...
    public Account() {
        this(56789,250,"Default","Default Phone","Default Email");
        System.out.println("Empty Constructor Called");
    }

    public Account(String customerName, String customerEmail, String customerPhoneNumber) {
        this(12,1000,customerName,customerEmail,customerPhoneNumber);
    }

    public Account(int accountNumber, int accountBalance, String customerName, String customerPhoneNumber, String customerEmail) {
