...
//	albums.add(revival);
	...
	Playlist myfavouritePlaylist = new Playlist("My Favourite Playlist");
...
//    printPlaylistSongs(myfavouritePlaylist.getPlaylist());
        playPlaylist(myfavouritePlaylist.getPlaylist());
